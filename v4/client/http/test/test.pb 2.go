...
// source: github.com/go-micro/plugins/v4/client/http/proto/test.proto
// DO NOT EDIT!
...
func init() {
	proto.RegisterFile("github.com/go-micro/plugins/v4/client/http/proto/test.proto", fileDescriptor0)
}
